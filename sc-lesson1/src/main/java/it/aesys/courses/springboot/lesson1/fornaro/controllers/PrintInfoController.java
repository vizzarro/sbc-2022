...
import it.aesys.courses.springboot.lesson1.config.FornaroConfig;
...
@RestController
@RequestMapping("fornaro")
public class PrintInfoController {

    private FornaroConfig config;

    @Autowired
    public PrintInfoController(FornaroConfig config){
        super();
        this.config = config;
    }
